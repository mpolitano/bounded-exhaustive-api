...
public abstract class GenInputsAbstract extends CommandHandler {
  ...
  public static int max_extensions_primitives = Integer.MAX_VALUE;
  ...
  @Option("Use toString method as an oracle")
  public static boolean tostring_oracle = false;

  @Option("Use toString method as abstraction function to remove redundancy in generation phase")
  public static boolean tostring_abstraction = false;
 
  @Option("Exit if no new sequences are generated after <int> milliseconds")
  public static int exit_no_new_sequences = 3600000;
  
  @Option("Don't set/get public fields in tests")
  public static boolean ignore_public_fields = true;

  @Option("Generate all BE sequences. Might be too expensive")
  public static boolean all_sequences = true;
  
  @Option("Scope is strict, sequences building larger outputs are dropped")
  public static boolean strict_object_scope = true;
  
  @Option("New, supposedly more efficient field extensions. Must try")
  public static boolean efficient_extensions = true;
  
  @Option("Use new id triples extensions instead of strings as canonical objects representations") 
  public static boolean id_triples_extensions = false;

  @Option("Filename to serialize generated objects") 
  public static String serialize_objects = null;
  
  @Option("Discard BE sequences that are syntatically redundant. Saves all generated sequences and might consume a lot of RAM")
  public static boolean enable_syntactic_redundancy = false;
  
  @Option("Use object constructor")
  public static boolean use_object_constructor = false;
  
  @Option("Save all tests in second phase, even if they exceed scopes")
  public static boolean second_phase_save_all = false;
  ...
  @Option("Use private methods for test generation")
  public static boolean test_private_methods = false;
  
  @Option("Always save constructors in BE generation")
  public static boolean save_all_constructors = false;
  
  @Option("Avoid a single object to be generated in the assert phase because of too strong redundancy criteria")
  public static boolean assert_single_object_hack = false;

  @Option("Serialize all input/output objects when an object of this class is present at the end of a test")
  public static String serialize_in_out_class = null;

  @Option("Serialize input/outputs from a unique assert method to this folder")
  public static String serialize_in_out_folder = "./";
  
  @Option("Serialize objects from this class")
  public static String serialize_class = null;
  
  @Option("Serialize objects from this class to xml")
  public static String serialize_class_xml = null;
  ...
  @Option("File for writing generated inputs")
  public static String inputs_xml_file = "input_objects.xml";
  
  @Option("File for writing the results of assert methods (for inputs in inputs_xml_file)")
  public static String asserts_xml_file = "assert_objects.xml";
  
  @Option("Do not canonicalize fields that match regular expression <string>")
  public static Pattern omitfields = null;
  
  @Option("Do not stores fields that match regular expression <string> in extensions")
  public static Pattern dont_save_fields = null;
  ...
  @Option("Use methods that match this regular expression to generate objects in BE fashion")
  public static Pattern builder_methods = null;
  
  @Option("Apply field exhaustive filtering during BE generation")
  public static Filtering filtering = Filtering.BEALL;
  
  @Option("Use builders only starting at this sequence length")
  public static int builders_at_length = Integer.MAX_VALUE;
  
  @Option("Keep only sequences that build new objects. Drops failing or exception throwing sequences")
  public static boolean keep_only_builder_seqs = true;
  
  @Option("List methods and terminate")
  public static boolean only_list_methods = false;

  @Option("Print methods in JVM syntax")
  public static boolean print_jvm_methods = false;
  
  @Option("Discard sequences created during the first phase")
  public static boolean discard_generation_seqs = false;
  ...
  @Option("<filename> File to log generated sequences and canonical objects")
  public static String output_gen_seqs_objs = null;
  ...
  @Option("Canonicalizer config overrides all the canonicalizer parameters with those set in the file")
  public static String canonicalizer_cfg = null;

  @Option("Abstraction function")
  ...
  public static boolean only_test_public_members = true;
  ...
  @Option("Maximum number of iterations for inputs generation in BE")
  public static int max_BE_iterations = 100;
  
  @Option("Maximum number of inputs sequences generated in BE")
  public static int max_BE_inputs = Integer.MAX_VALUE;
  
  @Option("Maximum number of sequences generated in the second phase of BE")
  public static int max_BE_second_phase_seqs = Integer.MAX_VALUE;

  @Option("Maximum number of output sequences generated in the second phase of BE")
  public static int max_BE_second_phase_outputs = Integer.MAX_VALUE;

  @Option("Do not generate BE tests with more than <int> statements")
  public static int BEmaxsize = 100; 
  
  @Option("Instance generic type parameters only with Integer class")
  public static boolean instance_generics_integer = true;
  
  @Option("Instance Object type parameters only with integer values")
  public static boolean instance_object_integer = true;
  
  public static boolean generation_phase = true;

  @Option("Instance Object type parameters only with integer values during generation")
  public static boolean instance_object_integer_gen_phase = false; 
