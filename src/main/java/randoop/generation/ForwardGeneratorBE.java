...
import randoop.fieldextensions.AbstractionFunctionRedundancy;
import randoop.fieldextensions.CanonicalIdTriplesRedundancy;
...
import randoop.fieldextensions.ToStringRedundancy;
...
public class ForwardGeneratorBE extends AbstractGeneratorBE {
   ...
   */
  protected final Set<Sequence> allSequences;
  protected final Set<TypedOperation> observers;
  ...
  protected RandoopListenerManager assertMgr;
  ...
  public ForwardGeneratorBE(
    ...
    if (GenInputsAbstract.builders_at_length < Integer.MAX_VALUE ||
    		GenInputsAbstract.output_computed_builders != null) {
    	buildersManager = new ComputeBuildersManager(operations, GenInputsAbstract.builders_at_length);
    }
    else {
    ...
    case BEHASH:
    	redundancyStrat = new HashRedundancy(GenInputsAbstract.max_objects, 
    			...
    			GenInputsAbstract.output_gen_seqs_objs);
    	break; 
    	*/
    case BE:
    	...
    	break; 
    case BEALL:
    	if (GenInputsAbstract.id_triples_extensions)
    		// Warning: These are much slower than storing Strings in profiling experiments. 
    		// Should not be used
    		redundancyStrat = new CanonicalIdTriplesRedundancy(GenInputsAbstract.max_objects, 
    			GenInputsAbstract.max_array_objects, 
    			GenInputsAbstract.omitfields,
    			GenInputsAbstract.output_gen_seqs_objs);
    	else
    	...
    	break; 
    case BEABS:
    	if (GenInputsAbstract.tostring_abstraction)
    		redundancyStrat = new ToStringRedundancy(GenInputsAbstract.max_objects, 
    			GenInputsAbstract.max_array_objects, 
    			GenInputsAbstract.omitfields,
    			GenInputsAbstract.output_gen_seqs_objs);
    	else
    		redundancyStrat = new AbstractionFunctionRedundancy(GenInputsAbstract.max_objects, 
    			GenInputsAbstract.max_array_objects, 
    			GenInputsAbstract.omitfields,
    			GenInputsAbstract.output_gen_seqs_objs);
    	break; 
    case NO:
	  ...
	  if (GenInputsAbstract.assert_methods != null) {
		    switch (GenInputsAbstract.filtering) {
		    case FE:
		    	assertRedundancyStrat = new GlobalExtensionsRedundancy(GenInputsAbstract.max_objects, 
		    			GenInputsAbstract.max_array_objects, 
		    			GenInputsAbstract.omitfields);
		    	break;
		    	/*
		    case BEHASH:
		    	assertRedundancyStrat = new HashRedundancy(GenInputsAbstract.max_objects, 
		    			GenInputsAbstract.max_extensions_primitives, 
		    			GenInputsAbstract.max_array_objects, 
		    			GenInputsAbstract.omitfields,
		    			GenInputsAbstract.output_objects,
		    	...
		    	*/
		    case BE:
		    	assertRedundancyStrat = new CanonicalStringsRedundancy(GenInputsAbstract.max_objects, 
		    			GenInputsAbstract.max_array_objects, 
		    			GenInputsAbstract.omitfields,
		    			GenInputsAbstract.output_gen_seqs_objs);
		    	break; 
		    ...
		    case BEABS:
		    	...
		    	break;
		    case NO:
		    	assertRedundancyStrat = new OriginalRandoopManager();
		    	break;
		    }
		    
		    if (GenInputsAbstract.second_phase_save_all) {
		    	assertRedundancyStrat = new OriginalRandoopManager();
		    }
	  }
  ...
  public void gen() {
	  ...
	  for (; itNum <= maxSeqLength; itNum++) {
		  ...
		  BEIteration(prevMan, currMan, allSeqMan, redundancyStrat, buildersManager, executionVisitor, operations, itNum);
	  ...
	  if (GenInputsAbstract.assert_methods != null) {
		  ...
		  BEIteration(allSeqMan, currMan, null, assertRedundancyStrat, new DummyOperationManager(operations), assertionPhaseVisitor, assertMethods, itNum);
...
private void BEIteration(ComponentManager prevMan, ComponentManager currMan, ComponentManager allSeqMan, IRedundancyStrategy redundancyStrat, IOperationManager buildersManager, ExecutionVisitor executionVisitor, List<TypedOperation> op, int seqLength)
		throws Error {
	int exceptionSeqs = 0;
	  int builders = 0;
	  int execSeqs = 0;
