...
public abstract class AbstractGeneratorBE extends AbstractGenerator {
	...
	protected IRedundancyStrategy assertRedundancyStrat;
	protected IOperationManager buildersManager;
  ...
  public void explore() {
    ...
    if (!GenInputsAbstract.noprogressdisplay) {
      progressDisplay = new ProgressDisplay(this, listenerMgr, ProgressDisplay.Mode.MULTILINE, 400);
