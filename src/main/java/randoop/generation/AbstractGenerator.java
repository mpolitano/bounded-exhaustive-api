...
public abstract class AbstractGenerator {
  ...
  protected ExecutionVisitor assertionPhaseVisitor;
  ...
  public void addAssertionPhaseExecutionVisitor(ExecutionVisitor executionVisitor) {
	  if (executionVisitor == null) {
		  throw new IllegalArgumentException("executionVisitor must be non-null");
	  }
	  this.assertionPhaseVisitor = executionVisitor;
  }
