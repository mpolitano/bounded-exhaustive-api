...
public class ProgressDisplay extends Thread {
  ...
  private static int exit_if_no_new_sequences_after_mseconds = GenInputsAbstract.exit_no_new_sequences;
//  private static int exit_if_no_new_sequences_after_mseconds = 3600000;
//  private static int exit_if_no_new_sequences_after_mseconds = 36000000;
